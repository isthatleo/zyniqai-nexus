...
const caseStudies = [
  {
    ...
    quote: "ZyniqAI transformed our operations. Their predictive models cut our downtime by 40%.",
    quotePerson: "Sarah Chen, VP of Engineering",
  },
  {
    client: "NovaTech Industries",
    industry: "Financial Services",
    challenge: "Fragmented data silos preventing real-time decision-making across 12 departments.",
    solution: "Built a centralized AI analytics platform with custom dashboards, anomaly detection, and automated reporting.",
    results: [
    ...
    quote: "We're making data-driven decisions in real-time now, not quarterly.",
    quotePerson: "Marcus Williams, Chief Data Officer",
  },
  {
    client: "Apex Financial Group",
    industry: "Enterprise SaaS",
    challenge: "Legacy systems causing 99.1% uptime with no observability into production failures.",
    solution: "Complete infrastructure overhaul with cloud migration, observability dashboards, and AI incident prediction.",
    results: [
    ...
    quote: "ZyniqAI delivered enterprise-grade AI systems on time and on budget.",
    quotePerson: "Elena Rodriguez, CTO",
  },
  {
    client: "Coastal Resorts Group",
    industry: "Hospitality",
    challenge: "Manual booking management, no revenue analytics across 8 properties.",
    solution: "Deployed ZyniqAI Hospitality OS with integrated booking engine, revenue dashboards, and AI forecasting.",
    results: [
    ...
    quote: "We went from spreadsheets to a fully intelligent hotel platform in 12 weeks.",
    quotePerson: "James Nkosi, Operations Director",
  },
  {
    client: "Greenfield Academy",
    industry: "Education",
    challenge: "Disconnected admin systems, manual attendance, no fee tracking.",
    solution: "Built ZyniqAI Education OS with student management, attendance, fee tracking, and AI enrollment forecasting.",
    results: [
    ...
    quote: "Our teachers can finally focus on teaching.",
    ...
    <div className="pt-20">
      <section className="section-padding relative">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <span className="text-xs font-medium tracking-widest uppercase text-primary mb-4 block">Case Studies</span>
            <h1 className="text-3xl md:text-5xl font-display font-bold mb-4">
              Real Results. <span className="gradient-text">Real Impact.</span>
            </h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              See how enterprises across industries leverage ZyniqAI to transform operations and drive intelligent growth.
            </p>
          </motion.div>
              ...
              >
                <div className="p-6 sm:p-8">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-6">
                    ...
                    <span className="text-xs font-medium tracking-widest uppercase px-3 py-1 rounded-full border border-primary/20 text-primary">
                      {study.industry}
                    </span>
                  </div>
          ...
          >
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-lg bg-primary text-primary-foreground font-medium text-sm hover:shadow-[0_0_30px_hsl(var(--gold)/0.4)] transition-all duration-300"
            >
